...
// Start page
Html::header(__('Blacklist Management', 'softwaremanager'), $_SERVER['PHP_SELF'], 'admin', 'PluginSoftwaremanagerMenu');
...
Search::show('PluginSoftwaremanagerSoftwareBlacklist');
